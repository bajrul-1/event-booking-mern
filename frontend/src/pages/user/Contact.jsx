...
function Contact() {
    ...
    return (
        <>
            <title>Contact Us - Get in Touch | EventBooking</title>
            <meta name="description" content="Have questions about our events or booking process? Contact the EventBooking team today. We are here to help you 24/7." />
            <meta name="keywords" content="contact, support, help, event booking, customer service" />
