...
import { createNewCategory, fetchAllCategoriesForAdmin, clearCategoryError } from '../../redux/features/categories/categoriesSlice.js';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-lg">
                        <h2 className="text-2xl font-bold font-heading text-neutral-800 dark:text-neutral-100 mb-6 flex items-center gap-2">
                            <Layers size={24} />
                            Create New Category
                        </h2>
                        <Formik
                        ...
                        >
                            {({ isSubmitting }) => (
                                <Form className="space-y-4">
                                    ...
                                    >
                                        {isSubmitting ? <LoaderCircle className="animate-spin" /> : 'Create Category'}
                                    </button>
                                </Form>
                            )}
                        </Formik>
                                    ...
                                    {categories.map(cat => (
                                        <li key={cat._id} className="py-4 flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button className="p-2 text-error-500 hover:bg-error-500/10 rounded-full transition-colors">
                                                    <Trash2 size={18} />
                                                </button>
                                            </div>
                                        </li>
